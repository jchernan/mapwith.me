...
L.Map = L.Class.extend({
	...
	setZoom: function (zoom, silent) { // (Number)
		return this.setView(this.getCenter(), zoom, false, silent);
	},
	...
	panTo: function (center, silent) { // (LatLng)
		return this.setView(center, this._zoom, false, silent);
	},
	...
	_resetView: function (center, zoom, preserveMapOffset, afterZoomAnim, silent) {
        ...
        if (typeof(silent) === "undefined" || silent !== true) {
            this.fire('userviewreset', {hard: !preserveMapOffset});
            window.console.error('userviewreset fired');
        } else {
            window.console.error('no userviewreset fired');
        }
...
L.Map.include(!(L.Transition && L.Transition.implemented()) ? {} : {
	setView: function (center, zoom, forceReset, silent) {
		...
		// reset the map view
		this._resetView(center, zoom, false, false, silent);
